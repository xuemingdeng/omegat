...
public class TestTeamIntegrationChild {
    ...
    static void checkAll() throws Exception {
        ...
        Core.getProject().iterateByDefaultTranslations(new DefaultTranslationsIterator() {
            public void iterate(String source, TMXEntry trans) {
                Integer prev = values.get(source);
                if (prev == null) {
                    prev = 0;
                }
                int curr = Integer.parseInt(trans.translation);
                if (curr < prev) {
     ...
     */
    static void saveTranslation(SourceTextEntry ste, int value) {
        PrepareTMXEntry prep = new PrepareTMXEntry();
    ...
    static class TestRealProject extends RealProject {
                ...
                StmProperties props = new StmProperties()
                        ...
                        .setResolutionStrategy(new ResolutionStrategy() {
                            ...
                            public ITuv resolveConflict(Key key, ITuv baseTuv, ITuv projectTuv, ITuv headTuv) {
                                TMXEntry enBase = (TMXEntry) baseTuv.getUnderlyingRepresentation();
                                TMXEntry enProject = (TMXEntry) projectTuv.getUnderlyingRepresentation();
                                TMXEntry enHead = (TMXEntry) headTuv.getUnderlyingRepresentation();
                                String s = "Rebase " + enProject.source + " base=" + enBase.translation
                                        + " head=" + enHead.translation + " project=" + enProject.translation;
        ...
        int v(TMXEntry e) {
            if (e == null) {
                ...
                return Integer.parseInt(e.translation);
            }
        }
