...
public class PoOptionsDialog extends javax.swing.JDialog {
    ...
    public PoOptionsDialog(Dialog parent, Map<String, String> options) {
        ...
        if ("true".equalsIgnoreCase(options.get(PoFilter.OPTION_FORMAT_ID))) {
            formatIdentifiedID.setSelected(true);
        } else {
    ...
    private void initComponents() {
        ...
        formatIdentifiedID = new javax.swing.JRadioButton();
        ...
        buttonGroup1.add(formatIdentifiedID);
        org.openide.awt.Mnemonics.setLocalizedText(formatIdentifiedID, OStrings.getString("POFILTER_FORMAT_IDENTIFIED")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 3;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.WEST;
        gridBagConstraints.insets = new java.awt.Insets(3, 3, 3, 3);
        jPanel1.add(formatIdentifiedID, gridBagConstraints);
    ...
    private void okButtonActionPerformed(java.awt.event.ActionEvent evt)// GEN-FIRST:event_okButtonActionPerformed
    {
        ...
        options.put(PoFilter.OPTION_FORMAT_ID, Boolean.toString(formatIdentifiedID.isSelected()));
    ...
    private javax.swing.JRadioButton formatIdentifiedID;
