...
public class StatisticsSettings {
    public static boolean isCountingProtectedText() {
        return Preferences.isPreferenceDefault(Preferences.STAT_COUNTING_PROTECTED_TEXT, false);
    }
    ...
    public static boolean isCountingStandardTags() {
        return Preferences.isPreferenceDefault(Preferences.STAT_COUNTING_STANDARD_TAGS, false);
    }

    public static void setCountingStandardTags(boolean value) {
        Preferences.setPreference(Preferences.STAT_COUNTING_STANDARD_TAGS, value);
    }

    public static boolean isCountingCustomTags() {
        return Preferences.isPreferenceDefault(Preferences.STAT_COUNTING_CUSTOM_TAGS, false);
    }
