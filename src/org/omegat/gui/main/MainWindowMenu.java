...
public class MainWindowMenu implements ActionListener, MenuListener, IMainMenu {
    ...
    JMenuBar initComponents() {
        ...
        viewMarkGlossaryMatchesCheckBoxMenuItem
                .setIcon(MainMenuIcons.newUnderlineTextIcon(Styles.EditorColor.COLOR_FOREGROUND.getColor(),
                        new Font("Serif", Font.PLAIN, 12), 'G', Styles.EditorColor.COLOR_TRANSTIPS.getColor()));
